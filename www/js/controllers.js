...
.controller('UserController', function($scope,User, $window,$state) {
...
.controller('ChatController', function($scope, ChatMsg,socketio,$window,$stateParams,$state) {

    console.log($stateParams.chatId);
    socketio.emit('join', {'user_id':localStorage.user_id,'to_user_id':$stateParams.chatId,'socket_id':localStorage.socketID});
    // var vm = this;
    ...
    $scope.createMessage = function(){
      ...
      ChatMsg.create($scope.chatData)
        .success(function(data) {
          console.log(data);
          data.msg.content = $scope.chatData.content;
